...
// Get the token value
$theToken = json_decode(file_get_contents("php://input"))->theToken;
$theEmail = json_decode(file_get_contents("php://input"))->email;
// The token that you got from Frames
//$card_token = $_POST['theToken'];
...
// Return API call as Json

header('Content-Type: application/json');
echo $server_output;
// // //redirect to 3ds result
